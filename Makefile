...
pkgdatadir = $(datadir)/lightdm-webkit2-greeter
pkgincludedir = $(includedir)/lightdm-webkit2-greeter
pkglibdir = $(libdir)/lightdm-webkit2-greeter
pkglibexecdir = $(libexecdir)/lightdm-webkit2-greeter
...
abs_builddir = /tmp/lightdm-webkit2-greeter
abs_srcdir = /tmp/lightdm-webkit2-greeter
abs_top_builddir = /tmp/lightdm-webkit2-greeter
abs_top_srcdir = /tmp/lightdm-webkit2-greeter
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
